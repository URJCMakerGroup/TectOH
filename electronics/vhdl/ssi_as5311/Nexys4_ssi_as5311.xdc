...
set_property PACKAGE_PIN L3 [get_ports {d7cat_seg[7]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {d7cat_seg[7]}]
##Bank = 34, Pin name = IO_L3N_T0_DQS_34,					Sch name = CB
set_property PACKAGE_PIN N1 [get_ports {d7cat_seg[6]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {d7cat_seg[6]}]
##Bank = 34, Pin name = IO_L6N_T0_VREF_34,					Sch name = CC
set_property PACKAGE_PIN L5 [get_ports {d7cat_seg[5]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {d7cat_seg[5]}]
##Bank = 34, Pin name = IO_L5N_T0_34,						Sch name = CD
set_property PACKAGE_PIN L4 [get_ports {d7cat_seg[4]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {d7cat_seg[4]}]
##Bank = 34, Pin name = IO_L2P_T0_34,						Sch name = CE
set_property PACKAGE_PIN K3 [get_ports {d7cat_seg[3]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {d7cat_seg[3]}]
##Bank = 34, Pin name = IO_L4N_T0_34,						Sch name = CF
set_property PACKAGE_PIN M2 [get_ports {d7cat_seg[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {d7cat_seg[2]}]
##Bank = 34, Pin name = IO_L6P_T0_34,						Sch name = CG
set_property PACKAGE_PIN L6 [get_ports {d7cat_seg[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {d7cat_seg[1]}]

##Bank = 34, Pin name = IO_L16P_T2_34,						Sch name = DP
set_property PACKAGE_PIN M4 [get_ports d7cat_seg[0]]							
	set_property IOSTANDARD LVCMOS33 [get_ports d7cat_seg[0]]

##Bank = 34, Pin name = IO_L18N_T2_34,						Sch name = AN0
set_property PACKAGE_PIN N6 [get_ports {d7an_sel[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {d7an_sel[0]}]
##Bank = 34, Pin name = IO_L18P_T2_34,						Sch name = AN1
set_property PACKAGE_PIN M6 [get_ports {d7an_sel[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {d7an_sel[1]}]
##Bank = 34, Pin name = IO_L4P_T0_34,						Sch name = AN2
set_property PACKAGE_PIN M3 [get_ports {d7an_sel[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {d7an_sel[2]}]
##Bank = 34, Pin name = IO_L13_T2_MRCC_34,					Sch name = AN3
set_property PACKAGE_PIN N5 [get_ports {d7an_sel[3]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {d7an_sel[3]}]
##Bank = 34, Pin name = IO_L3P_T0_DQS_34,					Sch name = AN4
set_property PACKAGE_PIN N2 [get_ports {d7an_sel[4]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {d7an_sel[4]}]
##Bank = 34, Pin name = IO_L16N_T2_34,						Sch name = AN5
set_property PACKAGE_PIN N4 [get_ports {d7an_sel[5]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {d7an_sel[5]}]
##Bank = 34, Pin name = IO_L1P_T0_34,						Sch name = AN6
set_property PACKAGE_PIN L1 [get_ports {d7an_sel[6]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {d7an_sel[6]}]
##Bank = 34, Pin name = IO_L1N_T034,							Sch name = AN7
set_property PACKAGE_PIN M1 [get_ports {d7an_sel[7]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {d7an_sel[7]}]
...
set_property PACKAGE_PIN F14 [get_ports {ssi_data_in}]				
	#set_property IOSTANDARD LVCMOS33 [get_ports {JA[1]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {ssi_data_in}]
##Bank = 15, Pin name = IO_L16N_T2_A27_15,					Sch name = JA3
#set_property PACKAGE_PIN D17 [get_ports {JA[2]}]	
set_property PACKAGE_PIN D17 [get_ports {ssi_clk_out}]		
	#set_property IOSTANDARD LVCMOS33 [get_ports {JA[2]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {ssi_clk_out}]
##Bank = 15, Pin name = IO_L16P_T2_A28_15,					Sch name = JA4
#set_property PACKAGE_PIN E17 [get_ports {JA[3]}]
set_property PACKAGE_PIN E17 [get_ports {ssi_cs_n_out}]
	#set_property IOSTANDARD LVCMOS33 [get_ports {JA[3]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {ssi_cs_n_out}]
